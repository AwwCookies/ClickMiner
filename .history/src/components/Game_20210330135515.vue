  ...
  <div class="game">
    <div class="mine">
      <div class="numbers">
        ...
        <div class="exprience">{{ level }} | {{ curExp }}/{{ neededExp }}</div>
        <div class="progress xpbar" :data-label="xpbar">
          <span class="value" style="width: 13%"></span>
        </div>
        <div class="skills">
...
export default defineComponent({
  setup() {
    ...
    const xpbar = computed(() => {
      return `Level: ${level.value} Experience: ${curExp.value}/${neededExp}`
    })
